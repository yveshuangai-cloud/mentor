...
gcloud run deploy "$SERVICE" \
  ...
  --set-env-vars="NODE_ENV=production,PUBLIC_BASE_URL=${INITIAL_URL},VOICE_BUCKET=mantou-voice-2026,LINEPAY_SANDBOX=true,LINE_LOGIN_CHANNEL_ID=${LINE_LOGIN_CHANNEL_ID},LIFF_ID=${LIFF_ID},AIEQ_LIFF_ID=${AIEQ_LIFF_ID},TURN_SHADOW_ENABLED=true" \
