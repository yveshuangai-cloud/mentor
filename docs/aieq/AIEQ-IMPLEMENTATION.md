...
使用者可以從 LINE OA 說「開始 AIEQ」，以 Flex 卡或自然文字完成 10 題測評；中斷後可續答。完成後得到四組人格偏好、六項獨立 AIEQ 能力、信心程度與動物視覺。使用者進入 LIFF 確認結果，選擇是否供朋友看見、是否允許饅頭參考溝通方式；朋友透過限時邀請連結建立雙向關係後，才能在朋友圈看見彼此公開的類型。

## 營地與完成狀態

1. **測量站：完成。** 10 題行為情境，含 direct、reverse、cross-check；MBTI 偏好與六項 AIEQ 能力分開計算。
